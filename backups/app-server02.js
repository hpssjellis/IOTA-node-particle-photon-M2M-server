...
global.myReceiveAddressOld = '' // This will be auto generated
...
iota
  ...
  .then(myGenAddress => {
      ...
      console.log('global.myReceiveAddressOld')
      console.log(global.myReceiveAddressOld)
...
///////////////////////////////////////      end only after startup       ////////////////////////////////////////////////////////////////
   ...
   //  }
      ...
      if (response[myStateLoop].value >= 1   ){          myParticleSend('doAll', response[myStateLoop].value, myMessage);          myTempResponse += '<td>Added up to 256 tokens</td>'  }
